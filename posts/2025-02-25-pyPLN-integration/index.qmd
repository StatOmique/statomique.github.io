...
a quality control report for cohorts built through the batch effect correction features; a differential gene expression meta-analysis module.
...
-   **11h40-12h30** _Work and feedback around methylation_

  - **11h40-12h00** Valentin Coste, **Microarray vs NGS**
...
Chez le bovin, la méthylation de l’ADN pourrait potentiellement être utilisée pour prédire des phénotypes. Il existe plusieurs technologies permettant d’analyser cette dernière, chacune ayant certains points forts et des points faibles. Parmi celle-ci, l’équipe utiliser principalement des méthodes de séquençages par RRBS, et depuis peu des données obtenues par Micro-array. L’objectif de la présentation sera de présenter les types de données qui sont générées, et de montrer quelques comparaisons entre des données produites par séquençages ou par Micro-array. 
  ...
  -   **12h00-12h15** Luc Jouneau, **`{edgeR}`: Une solution pour l’analyse RRBS d’une expérience à 2 facteurs ?**
...
En pratique, quelles sont les atouts et inconvénients de l’application de `{edgeR}` sur ce type de données ?
  ...
  -   **12h15-12h30** Anne Frambourg, **Evaluation des résultats sur une analyse à 2 facteurs avec le package `{DSS}`**
...
-   **14h00 - 14h50** ![](/media/2025-02-25/clairegormley.png){width="100"} [Claire Gormley](http://www.maths.ucd.ie/~cgormley) **Integrated differential analysis of multi-omics data using a joint mixture model: idiffomix** 
